<template>
  <div class="main-page">
    <div class="header">
      <h1>SnapBox</h1>
      <p>J‰rjestelm‰ komponenttien hallintaan</p>
    </div>
